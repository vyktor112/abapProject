sap.ui.define([
    ...
    return Controller.extend("org.ubb.books.controller.Booklist", {
        ...
        onSavePressed(oEvent) {
            ...
            this.odataModel = new sap.ui.model.odata.ODataModel("/sap/opu/odata/SAP/Z801_ODATA_VITA_SRV");
            this.odataModel.create('/Z801_BOOK_ENTITY_VITASet', oBook);
            this.dialog.close();
            this.dialog.destroy();
        ...
        onUpdatePressed(oEvent) {
            ...
            this.odataModel = new sap.ui.model.odata.ODataModel("/sap/opu/odata/SAP/Z801_ODATA_VITA_SRV");
            this.odataModel.update("/Z801_BOOK_ENTITY_VITASet('" + oISBN + "')", oBook, null, function () {
